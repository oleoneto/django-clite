...
def new_app(name: str) -> Directory:
    return Directory(
        ...
        children=[
            ...
            File(name="apps.py", template="apps.tpl"),
            File(name="urls.py", template="urls.tpl"),
            File(name="constants.py", template="shared/empty.tpl"),
        ...
        if ctx.params.get("is_package", False):
            app = Directory(
                ...
                children=[
                    ...
                    File(name="setup.cfg", template="shared/setup_cfg.tpl"),
                    File(name="setup.py", template="shared/setup.tpl"),
                ],
            )
