...
import subprocess
import sys
from dj.cli import log_error, log_info, log_success, sanitized_string
...
from dj.cli.templates.git_repo.readme import readme_template
from dj.cli.templates.git_repo.gitignore import git_ignore_template
from dj.cli.templates.router import router_template
from dj.cli.templates.urls import app_urls_template
from dj.cli.templates.env import env_template
from dj.cli.templates.requirements import (
    requirements_template,
    pipenv_template
)
from dj.cli.templates.docker import (
    docker_compose_template,
    dockerfile_template
)
from dj.cli.templates.dokku import (
    app_template,
