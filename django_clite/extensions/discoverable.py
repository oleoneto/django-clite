...
from django_clite import COMMANDS_FOLDER, PLUGINS_FOLDER
from django_clite.constants import DEV_MODE_ENV_VAR
...
class DiscoverableGroup(MultiCommand):
    """
